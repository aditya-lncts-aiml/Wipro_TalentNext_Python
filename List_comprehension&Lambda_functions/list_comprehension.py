'''
Q1) Write a LC program to create an output dictionary which contains only the odd numbers that are present in the 
...
'''
import string
aplha_dict = {char: idx for idx, char in enumerate(string.ascii_lowercase, start=1)}
print(aplha_dict)
